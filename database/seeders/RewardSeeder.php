...
class RewardSeeder extends Seeder
{
    ...
    public function run()
    {
        $rewards = array(
            ...
            ['actions' => 'Accepting 1st Service Order Request', 'points' => 25, 'name' => 'accepting_1st_service_order_request'],
            ['actions' => 'Submit 1st Service Order Delivered', 'points' => 25, 'name' => 'submit_1st_service_order_delivered'],
            ...
            ['actions' => 'Receiving Service Order Request', 'points' => 50, 'name' => 'receiving_service_order_request'],
