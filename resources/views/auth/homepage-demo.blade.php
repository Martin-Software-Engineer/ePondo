   ...
   <body>
      ...
      <div class="about_section layout_padding">
         <div class="container">
            <div class="row">
               <div class="col-sm-8">
                  <h2 class="about_taital">about ePONDO</h2>
                  <p class="about_text"> ePONDO is a rewards crowdfunding platform
                  </p>
                  <div class="readmore_bt"><a href="img\epondo.png">Read more</a></div>
               </div>
               <div class="col-sm-4">
                  <div class="about_img"><img src="img\epondo.png"></div>
               </div>
            </div>
         </div>
      </div>
