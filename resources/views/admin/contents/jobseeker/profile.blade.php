...
<section class="app-user-edit">
    <div class="card">
                    ...
                    @else 
                        <div class="d-flex justify-content-left align-items-center">
                            <div class="avatar colorClass">
                                <span class="avatar-content avatar-header">{{strtoupper(System::get_avatar($user->username))}}</span>
                            </div>
        ...
        <div class="card-body">
            <!-- <form class="form-validate" id="form-profile" action="{{route('admin.jobseekers.profile.update', $user->id)}}">
                @csrf
                <div class="row mt-1">
                    <div class="col-12">
                        <h4 class="mb-1">
    ...
    <div class="card">
        ...
        <div class="card-body">
            <form class="form-validate" id="form-profile-pppp" action="{{route('admin.jobseekers.profile.updatepppp', $user->id)}}" method="POST">
                @csrf
                <div class="row">
