      ...
      <div class="banner_section layout_padding">
         <div class="container">
            <div id="carouselExampleIndicators" class="carousel slide" data-ride="carousel">
               <ol class="carousel-indicators" style='margin: 30px 0;'>
               ...
               <div class="carousel-inner">
                  <div class="carousel-item active">
                     <div class="row">
                        <div class="col-sm-12">
                           <h1  class="banner_taital">Welcome to ePONDO!</h1>
         ...
         <div class="fundraise_section">
            <div class="fundraise_section_main">
               <div class="row">
                  <div class="col-lg-4">
                     <div class="box_main">
                        <div class="icon_1"><i class="fas fa-hands-helping"></i>
                        </div>
                        <h4 class="volunteer_text">CAMPAIGNS</h4>
                        <p class="lorem_text">Campaigns</p>
                        <div class="join_bt"><a href="#">View More</a></div>
                     </div>
                  </div>
                  <div class="col-lg-4">
                     <div class="box_main active">
                        <h4 class="volunteer_text">SERVICES</h4>
                        <p class="lorem_text">Services</p>
                        <div class="join_bt"><a href="#">View More</a></div>
                     </div>
                  </div>
                  <div class="col-lg-4">
                     <div class="box_main">
                        <h4 class="volunteer_text">DONATIONS</h4>
                        <p class="lorem_text">Donate</p>
                        <div class="join_bt"><a href="#">View More</a></div>
                     </div>
                  </div>
               </div>
            ...
            <div class="row">
                <div class="col-lg-12">
                    <div class="section-title">
                        <h2 style='margin: 70px 0;'>Services </h2>
                    </div>
                </div>
            </div>
            <div class="row featured__filter">
                <div class="col-lg-3 col-md-4 col-sm-6 mix oranges fresh-meat">
                    <div class="featured__item">
                        <div class="featured__item__pic set-bg" data-setbg="https://media.istockphoto.com/photos/giving-a-hand-picture-id1166345507?k=6&m=1166345507&s=612x612&w=0&h=Wd_4hGEoy2_Kyn3qS8Xg5lo-1-fghU-YBFt_swBgmBo=">
...
<!-- about section start -->
<div class="about_section layout_padding" style='margin-top: 1000px;'>
         <div class="container">
            <div class="row">
               <div class="col-sm-8">
                  <h2 class="about_taital">What we Offer </h2>
                  <p class="about_text"> -Description-
                  </p>
                  <div class="readmore_bt"><a href="img\epondo.png">Read more</a></div>
               </div>
               <div class="col-sm-4">
                  <div class="about_img"><img src="https://images.unsplash.com/photo-1582803824594-65b5b4632cad?ixid=MXwxMjA3fDB8MHxzZWFyY2h8Mnx8aGVscGluZyUyMGhhbmR8ZW58MHx8MHw%3D&ixlib=rb-1.2.1&w=1000&q=80"></div>
               </div>
            </div>
         </div>
      </div>
...
<section class="featured spad">
        <div class="container">
            <div class="row">
                <div class="col-lg-12">
                    <div class="section-title">
                        <h2 style='margin-top:70px'>CAMPAIGNS </h2>
                    </div>
                </div>
            </div>
            <div class="row featured__filter">
 ...
 <footer id="footer">
<!--FOOTER SECTION -->
   <footer class="new_footer_area bg_color" style='margin-top: 2300px;'>
