...
<html lang="en">
	<head>
        ...
        <title>Non-profit and Charity</title>
 ...
 <nav>
        ...
        <div class="container-fluid" style="position: relative; top: 100px;">
			...
			<div class="cardsContainer page_container">

                <!-- <div class="row d-flex justify-content-center"> -->
                <div>
                    <div class="header page_container"style="margin-left: 80px" >
                            <h3>Non-profit and charity</h3>
                            <p>
                                Guide your users through your produce with clear, accessible UX
                                writing and microcopy
                            </p>
                        </div>

                        <div class="selectContainer page_container">
                            <select class="form-select" aria-label="Default select example" style="margin-left: 80px" >
				...
				<div class="row item_card_row d-flex justify-content-center">
					<!-- Card -->
					<div class="card item_card">
						<img
							src="https://petapixel.com/assets/uploads/2017/03/product1.jpeg"
							class="card-img-top"
							alt="..."
						/>
						<div class="card-body">
